...
NProduction = {
	...
	DEFAULT_MAX_NAV_FACTORIES_PER_LINE = 150, -- EBF Changed
	FLOATING_HARBOR_MAX_NAV_FACTORIES_PER_LINE = 150, -- EBF Changed
	CONVOY_MAX_NAV_FACTORIES_PER_LINE = 150, -- EBF Changed
	CAPITAL_SHIP_MAX_NAV_FACTORIES_PER_LINE = 150, -- EBF Changed
	MAX_MIL_FACTORIES_PER_LINE = 150, -- EBF Changed
	RAILWAY_GUN_MAX_MIL_FACTORIES_PER_LINE = 150 -- EBF Changed
...
NBuildings = {
	...
	MAX_SHARED_SLOTS = 25,				-- Max slots shared by factories EBF Changed
